...
namespace System.Data.DB2.EntityFramework.Migrations
{
    ...
    /// </summary>
    internal static class DB2DmlBuilder
    {
        ...
        internal static string GenerateInsertSql(DbInsertCommandTree tree, out List<DbParameter> parameters, bool insertParametersValuesInSql = false)
        {
            ...
            if (tree.SetClauses.Count != 0)
            {
                ...
                {
                    commandText.Append(DB2ProviderManifestHelper.QuoteIdentifier(guidAutogeneratedColumn));
                    first = false;
                }
            ...
            ExpressionTranslator translator, DbExpression returning)
        {
            ...
            foreach (EdmMember keyMember in table.ElementType.KeyMembers)
            {
                ...
                commandText.Append(DB2ProviderManifestHelper.QuoteIdentifier(keyMember.Name));
                commandText.Append(" = ");
        ...
        private class ExpressionTranslator : DbExpressionVisitor
        {
            ...
            internal DB2Parameter CreateParameter(object value, TypeUsage type)
            {
                var parameter = DB2ProviderServicesHelper.CreateDB2Parameter(
            ...
            {
                _commandText.Append(DB2ProviderManifestHelper.QuoteIdentifier(expression.Property.Name));
            }
        ...
        internal static string GetTargetTSql(EntitySetBase entitySetBase)
        {
            ...
            else
            {
                ...
                {
                    builder.Append(DB2ProviderManifestHelper.QuoteIdentifier(tableName));
                }
                else
                {
                    builder.Append(DB2ProviderManifestHelper.QuoteIdentifier(entitySetBase.Name));
                }
            }
