...
{
    static class DB2ProviderServicesHelper
    {
        ...
        /// information as well.
        /// </summary>
        private static DbType GetDB2DbType(TypeUsage type, bool isOutParam, out int? size)
        {
        ...
        /// <summary>
        /// Determines preferred value for DB2Parameter.Size. Returns null
